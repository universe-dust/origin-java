...
import com.originlang.domain.context.ioc.object.definition.ApplicationAnnotationObjectDefinition;
...
//    }
     ...
     */
    @Override
    public void createObject(List<String> classNameList) {
...
//               clazz.isLocalClass()
            ...
            Field[] fieldArray = clazz.getFields();
                for (Field field : fieldArray) {
                    ...
                    objectDefinition.fieldClazzList.add(fieldClazz);
                }
...
//                    clazz.getSuperclass();
                    ...
                    try {
                        proxyInstance = objectProxy.newProxyInstance(clazz.getInterfaces()[0],(InvocationHandler) executionClazz.getConstructor(Object.class).newInstance(object));
...
//                    ApplicationContext.registerSingleton(clazz.getInterfaces()[0].getName(),proxyInstance);
     ...
     */
    public void dependencyInjection(List<String> classFullNameList) {
        doDependencyInjection(classFullNameList);
    }


    private void doDependencyInjection(List<String> classFullNameList) {
